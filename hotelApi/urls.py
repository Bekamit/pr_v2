...
from account.views import UserViewSet, LoginView, RegisterView
from hotel.views import HotelViewSet, EquipmentViewSet, BookingViewSet, CommentViewSet
from restourant.views import CategoryViewSet, ProductViewSet, LikeCreateView
